...
<body>
  ...
  <td>
    ...
    <tr>
        <th style="border: 1px solid black;">ID Dosen</th>
    ...
    ?>
    <tr>
        <td style="border: 1px solid black;"><?= $data['id_dosen']?></td>
        <td style="border: 1px solid black;"><?= $data['nama']?></td>
        <td style="border: 1px solid black;">
            <select name="kelas">
                <option value="1" <?= $data['jenis_kelas'] == 1 ? "selected" : "" ?>> Online</option  readonly>
                <option value="2" <?= $data['jenis_kelas'] == 2 ? "selected" : "" ?>> Offline </option>
                <option value="3" <?= $data['jenis_kelas'] == 3 ? "selected" : "" ?>> Hybrid </option>
            </select>
        </td>
        ...
        <td style="border: 1px solid black;">
            ...
            <a href="edit.php?id_dosen=<?= $data ['id_dosen'] ?>"><button>Edit</button></a>
            <a href="delete.php?id_dosen=<?= $data ['id_dosen'] ?>"><button>Delete</button></a>
        </td>
    </tr>
    <?php } ?>
</table>
